...
export class FeatureService {
  ...
  AIML = [
    {
      module: "Neural networks and deep learning algorithms",
      feature: [
    ...
    {
      module: "Natural language processing (NLP) modules",
      feature: [
        "Text classification",
        "Sentiment analysis",
    ...
    {
      module: "Image and video recognition modules",
      feature: [
        "Object detection",
        "Image segmentation",
        "Facial recognition",
    ...
    {
      module: "Predictive analytics and recommendation engines",
      feature: [
        "Data analysis",
        "pattern recognition",
        "predictive modeling",
  ...
  FinTech = [
    { module: "Payment processing and gateway integration", feature: [] },
  ...
  HealthTech = [
    {
      module: "Electronic health records (EHR) management systems",
      feature: [
    ...
    {
      module: "Telemedicine and remote patient monitoring modules",
      feature: [
        "Video consultations",
    ...
    {
      module: "Medical imaging and diagnostic software",
      feature: [
        "Image acquisition",
    ...
    {
      module: "Health information exchange (HIE) platforms",
      feature: [
        "Secure data sharing",
  ...
  AIMLModuleList = [
    ...
    "Image and video recognition modules",
    "Predictive analytics and recommendation engines",
  ];
  FinTechModuleList = [
    "Payment processing and gateway integration",
    "Cryptocurrency and blockchain modules ",
    "Financial data analysis and reporting tools",
    "Risk management and compliance solutions",
  ];
  HealthTechModuleList = [
    "Electronic health records (EHR) management systems",
    "Telemedicine and remote patient monitoring modules",
    "Medical imaging and diagnostic software",
    "Health information exchange (HIE) platforms",
  ];
  CybersecurityModuleList = [
    "Network security and firewall solutions",
    "Threat detection and prevention modules",
    "Encryption and data protection software",
    "Security information and event management (SIEM) tools",
  ];
  RenewableModuleList = [
    "Energy management and monitoring systems",
    "Smart grid optimization and control software",
    "Simulation and modeling tools for renewable energy sources",
    "Energy storage and battery management solutions",
  ];
  EdTechModuleList = [
    "Learning management system (LMS) platforms",
    "Virtual classroom and online course creation tools",
    "Assessment and grading modules",
    "Personalized adaptive learning software",
  ];
  VirtualRealityModuleList = [
    "Virtual reality (VR) and augmented reality (AR) development frameworks ",
    "3D modeling and rendering tools",
    "Interactive and immersive content creation modules",
    "Gesture and motion tracking software",
  ];
  TransportationModuleList = [
    "Route optimization and fleet management systems",
    "Supply chain visibility and tracking modules",
    "Warehouse management and inventory control software",
    "Delivery management and logistics planning tools",
  ];
  RemoteModuleList = [
  ...
  getModuleList(industryType) {
    if (industryType == "Supply chain") {
      ...
      industryType == "Artificial Intelligence(AI) and Machine Learning(ML)"
    ) {
      return this.AIML;
  ...
  getApp(selectedList) {
    if (selectedList) {
      return this.http
        .post(
          `https://abf9-111-93-95-94.in.ngrok.io/api/get_features`,
          selectedList
        )
        .pipe(map((rsp) => rsp));
    }
